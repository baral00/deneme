    ...
    return (
        <section id="about" className="py-24 relative overflow-hidden bg-gradient-to-b from-[#FCFAF8] to-[#F7F4ED]">
            ...
            <Container maxWidth="lg" className="relative z-10">
                <Box sx={{ display: 'grid', gridTemplateColumns: { xs: 'minmax(0, 1fr)', md: '1fr 1fr' }, gap: { xs: 3, md: 8 }, alignItems: 'center' }}>
                    <Box>
                    ...
                    <Box>
                        <FadeInUp delay={0.2}>
                            <Paper
                                className="bg-white/80 backdrop-blur-sm p-4 md:p-12 relative overflow-hidden group shadow-xl shadow-gold/5"
                                elevation={0}
                            >
                                ...
                                <Box className="relative z-10 space-y-10 md:space-y-12">
                                    <StaggerContainer staggerChildren={0.3} className="will-change-transform">
                                        <StaggerItem>
                                            <Typography
                                                variant="h5"
                                                className="text-emerald mb-3 md:mb-4 font-serif text-lg md:text-2xl break-words"
                                        ...
                                        <StaggerItem className="border-t border-gold/10 pt-6 md:pt-8 text-left">
                                            <Typography
                                                variant="h5"
                                                className="text-emerald mb-3 md:mb-4 font-serif text-lg md:text-2xl break-words"
                                                sx={{ textWrap: 'balance' } as any}
