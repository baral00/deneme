...
# The literal content we want, ensuring NO hidden characters.
# We use literal strings for the email to be absolutely sure.
...
export async function POST(req: Request) {
    try {
        ...
        console.log(`Type: ${eventType} | Date: ${date}`);
...
with open(route_path, "w", encoding="ascii") as f:
    f.write(content)

print("Successfully wrote route.ts as PURE ASCII.")
